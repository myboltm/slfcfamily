        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              <EditableText contentKey="footer.tagline" defaultValue="A body of Christ dedicated to sharing God's love, growing in faith, and serving our community with compassion and grace." multiline />
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-gray-300"><EditableText contentKey="footer.address" defaultValue="behind state hospital, Obasanjo farm road, off idiroko road ota ogun state" multiline /></p>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-purple-400 mr-3" />
                <p className="text-gray-300"><EditableText contentKey="footer.phone" defaultValue="+2347033579391" /></p>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-purple-400 mr-3" />
                <p className="text-gray-300"><EditableText contentKey="footer.email" defaultValue="contact@slfcfamilyww.org" /></p>
              </div>
            </div>

            <div className="mt-8 p-4 bg-gray-800 rounded-lg">
              <h5 className="font-semibold text-purple-400 mb-2">Service Times</h5>
              <p className="text-sm text-gray-300"><EditableText contentKey="footer.service1" defaultValue="Sunday Worship: 8:00 AM" /></p>
              <p className="text-sm text-gray-300"><EditableText contentKey="footer.service2" defaultValue="Wednesday Bible Study: 10:00 AM" /></p>
            </div>
          </div>
        </div>
